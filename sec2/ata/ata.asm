...
.still_going_cr:
    ...
    jz .still_going_cr        ;until the sector buffer is ready.
...
.still_going_lr:  
    in al, dx
    test al, 8           ; the sector buffer requires servicing.
    jz .still_going_lr      ; until the sector buffer is ready.
...
.still_going_lw: 
    in al, dx
    test al, 8           ; the sector buffer requires servicing.
    jz .still_going_lw      ; until the sector buffer is ready.
